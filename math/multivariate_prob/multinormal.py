#!/usr/bin/env python3
"""
This module contains the class MultiNormal to represent a Multivariate Normal distribution.
"""
...
class MultiNormal:
    ...
    def pdf(self, x):
        ...
        Parameters:
        x (numpy.ndarray): A data point of shape (d, 1) whose PDF should be calculated.
